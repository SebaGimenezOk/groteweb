...
const AudioPlayer = () => {
    ...
    return (
        <div className="flex text-cyan-800 justify-center items-center  h-20" >
            <audio ref={audioPlayer} src='https://radiostreamingserver.com.ar/proxy/raidogrote/stream?type=.mp3' preload='metadata'></audio>

            <div>
                < IoPlayBackSharp size={23} />
            </div>
            <button className='flex px-4  justify-center items-center text-cyan-800' onClick={togglePlayPause}>
            ...
            <div className='justify-center items-center hidden md:flex'>
                ...
                <input className='bg-cyan-800' type="range" min="0" max="100" onChange={handleVolumeChange} />
            </div>
        </div>
    );
};
